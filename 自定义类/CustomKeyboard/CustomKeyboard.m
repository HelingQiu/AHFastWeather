...
@synthesize currentSelectedTextboxIndex = _currentSelectedTextboxIndex;
...
- (UIBarButtonItem *)getNextPrevButtons:(BOOL)prevEnabled :(BOOL)nextEnabled {
    UISegmentedControl *tabNavigation = [[UISegmentedControl alloc] initWithItems:[NSArray arrayWithObjects:@"上一项", @"下一项", nil]];
